    ...
    <footer className="relative z-10 pt-24 pb-24 md:pb-12 border-t border-slate-200/50 bg-white/60">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1"><div className="flex items-center gap-2 mb-2"><span className="w-7 h-7 rounded-lg bg-gradient-to-br from-ice-500 to-violet-glow grid place-items-center text-white font-bold text-xs">A</span><strong className="font-heading text-sm text-slate-800">{BRAND.name.toUpperCase()}</strong></div><p className="text-xs text-slate-400">{BRAND.tagline}</p></div>
