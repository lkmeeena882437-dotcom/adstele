    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <a href="#top" className="flex items-center gap-2.5 group" onClick={() => trackEvent('nav_click', { item: 'brand' })}>
          <span className="w-8 h-8 rounded-lg bg-gradient-to-br from-ice-500 via-cyan-glow to-violet-glow grid place-items-center text-white font-bold text-sm shadow-lg shadow-ice-500/40 group-hover:scale-105 transition-transform">A</span>
