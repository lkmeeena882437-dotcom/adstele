...
export default function Section({ id, scene, ghost, children, className = '', containerClass = '' }: SectionProps) {
  return (
    <section id={id} data-scene={scene} className={`relative py-14 sm:py-20 md:py-24 ${className}`}>
      ...
      <m.div
        ...
        className={`relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ${containerClass}`}
      >
        {children}
      </m.div>
    </section>
